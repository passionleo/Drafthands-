...
export const INITIAL_STUDENT_SUBMISSIONS: StudentSubmission[] = [
  {
    ...
    studentEmail: 'c.nnamdi@student.drafthands.edu.ng',
  ...
  },
  {
    ...
    studentName: 'Fatima Aminu',
    studentEmail: 'f.aminu@student.drafthands.edu.ng',
    ...
    grade: {
      ...
      gradedBy: 'Engr. Drafthands Faculty Lead',
  ...
  },
  {
    ...
    studentEmail: 'o.adeyemi@student.drafthands.edu.ng',
